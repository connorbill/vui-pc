  ...
  export default {
    ...
    computed: {
      model: {
        ...
        set(val) {
          if (this.isGroup) {
            ...
            this.isLimitExceeded === false &&
            this.dispatch('VuiCheckboxGroup', 'input', [val]);
          } else {
            this.$emit('input', val);
            this.selfModel = val;
          }
      ...
      isGroup() {
        ...
        while (parent) {
          if (parent.$options.componentName !== 'VuiCheckboxGroup') {
    ...
    methods: {
      ...
      handleChange(ev) {
        ...
        this.$nextTick(() => {
          if (this.isGroup) {
            this.dispatch('VuiCheckboxGroup', 'change', [this._checkboxGroup.value]);
          }
        });
      }
    },
