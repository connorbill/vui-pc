                            ...
                            <div class="show-three-talk">
                                <router-link :to="{ name: 'detail', params: { id: item.postId }}">
                                    <div class="show-talk-item">
                                        <div v-if="item.postReplyId < 1" class="talk-word overflow-word">回复帖子：{{item.title}}</div>
                                        <div v-if="item.postReplyId > 0" class="talk-word overflow-word">回复评论：{{item.content2}}</div>
                                    </div>
                                </router-link>
                            </div>
                        </div>
                    </div>
                    <!--<div v-if="item.replayReply">-->
                        <!--<div class="person-con">-->
                            <!--<div class="con-detail m-text-to-me">-->
                                <!--{{item.content}}-->
                            <!--</div>-->
                        ...
                        <!--<div class="show-talk">-->
                            <!--<div class="show-three-talk">-->
                                <!--<router-link :to="{ name: 'detail', params: { id: item.postId }}">-->
                                    <!--<div class="show-talk-item">-->
                                            <!--<div class="talk-word overflow-word">{{item.content2}}</div>-->
                                    <!--</div>-->
                                <!--</router-link>-->
                            <!--</div>-->
                        <!--</div>-->
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getCardList () {
                this.$http.MyService.getMyReply(this.cardPageNum)
                    .then(res => {
