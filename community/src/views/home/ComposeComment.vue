<template>
    <div class="m-main m-pos-f m-box-model">
        ...
        <!--&gt;</van-nav-bar>-->
        <!--</div>-->
        <!--<div class="m-box-model height-per-hundred">-->
        <!--<main class="m-reles-con m-lim-width m-box-model m-flex-shrink1 m-flex-grow1 m-con-top">-->
        <!--<div class="m-box-model m-pos-r" draggable="true">-->
        <!--<div class="m-box-model m-fd-row m-reles-nr">-->
        <!--<div class="textarea-wrapper">-->
        <!--<div-->
        ...
        <!--&lt;!&ndash;id="textarea"&ndash;&gt;-->
        <!--&lt;!&ndash;class="field-textarea"&ndash;&gt;-->
        <!--&lt;!&ndash;placeholder="请输入详细地址"></textarea>&ndash;&gt;-->
        ...
        <!--</div>-->
        <!--</div>-->
        <!--<van-loading type="spinner" color="white" class="fixed-middle-center demo-loading" v-show="isSending"/>-->
        <!--</main>-->
        <!--<footer class="m-box-model m-lim-width" style="overflow: hidden;">-->
        <!--<div class="composer-footer m-fd-row">-->
        <!--<div class="composer-footer-box m-ctrl-box m-box-center-a">-->
        <!--<div style="flex: 1 1 0%;"></div>-->
        <!--<span class="m-reles-fnum m-wz-def">{{ replayNum }}/300</span>-->
        <!--</div>-->
        <!--</div>-->
        <!--</footer>-->
        <!--</div>-->
        ...
        methods: {
            ...
            onClickRight () {
                ...
                if (!this.isSending) {
                    this.isSending = true;
                    let sendData = {
                        postId: this.postId, content: trimWord
                    };
