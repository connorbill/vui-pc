...
```html
<template>
  <vui-button type="text" @click="open">Click to open the Message Box</vui-button>
</template>
...
```html
<template>
  <vui-button type="text" @click="open2">Click to open the Message Box</vui-button>
</template>
...
```html
<template>
  <vui-button type="text" @click="open3">Click to open Message Box</vui-button>
</template>
...
```html
<template>
  <vui-button type="text" @click="open4">Click to open Message Box</vui-button>
</template>
...
```html
<template>
  <vui-button type="text" @click="open5">Click to open Message Box</vui-button>
</template>
...
```html
<template>
  <vui-button type="text" @click="open6">Click to open Message Box</vui-button>
</template>
...
```html
<template>
  <vui-button type="text" @click="open7">Click to open Message Box</vui-button>
</template>
