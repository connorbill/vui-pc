...
```html
<template>
  <vui-button :plain="true" @click="open">Show message</vui-button>
  <vui-button :plain="true" @click="openVn">VNode</vui-button>
</template>
...
```html
<template>
  <vui-button :plain="true" @click="open2">success</vui-button>
  <vui-button :plain="true" @click="open3">warning</vui-button>
  <vui-button :plain="true" @click="open">message</vui-button>
  <vui-button :plain="true" @click="open4">error</vui-button>
</template>
...
```html
<template>
  <vui-button :plain="true" @click="open5">message</vui-button>
  <vui-button :plain="true" @click="open6">success</vui-button>
  <vui-button :plain="true" @click="open7">warning</vui-button>
  <vui-button :plain="true" @click="open8">error</vui-button>
</template>
...
```html
<template>
  <vui-button :plain="true" @click="openCenter">Centered text</vui-button>
</template>
...
```html
<template>
  <vui-button :plain="true" @click="openHTML">Use HTML String</vui-button>
</template>
